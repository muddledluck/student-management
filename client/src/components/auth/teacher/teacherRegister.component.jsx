...
import { registerTeacher } from "../../../redux/teacher/teacher.actions";
import classnames from "classnames";

const DEPARTEMENT = ["EC", "CSE", "Automobile", "Chem", "EE"];
...
); // we are using withRouter here because we need to redirect to login page after registration is completed, withRouter() send history to the action
